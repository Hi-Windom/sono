...
_REPAIR_MODULES = {
    ...
    "v3.3": "services.repair.repair_v3_3",
    "v3.3+": "services.repair.repair_v3_3p",
    "v3.3a": "services.repair.repair_v3_3a",
    "v3.3a+": "services.repair.repair_v3_3ap",
}
...
ALGORITHM_VERSIONS = {
    ...
    "v3.3": {
        "name": "v3.3",
        "label": "v3.3",
        "description": "统计自然化版：频谱自然化+瞬态保护+相位扩散+动态自然化（推荐主力）",
        "tags": ["desktop", "dual-track", "recommended"],
        "mobile_compatible": False,
        "supports_dual_track": True,
        "repair_version": "v3.3",
        "default_params": {
            ...
            "harmonic_deregularize": 0.7,
            "phase_naturalize": 0.5,
        ...
        "modes": [
            {
                "name": "自然化处理",
                "description": "频谱自然化+瞬态保护+相位扩散，降低AI检测置信度",
                "icon": "🌊",
                "params": {
                    "spectral_naturalize": 0.8,
                    "noise_floor_shape": 0.6,
    ...
    "v3.3+": {
        "name": "v3.3+",
        "label": "v3.3+",
        "description": "增强版：f0引导谐波+感知加权+预设系统(Anti-Detect/HiFi-Pure/Vocal)",
        "tags": ["desktop", "dual-track", "premium"],
        "mobile_compatible": False,
        "supports_dual_track": True,
        "repair_version": "v3.3+",
        "default_params": {
            ...
            "noise_floor_shape": 0.65,
            "harmonic_deregularize": 0.75,
            "phase_naturalize": 0.55,
            "transient_protect": 0.5,
        ...
        "modes": [
            {
                "name": "反检测模式",
                "description": "最强去相关+噪声塑形+谐波去规整，最大程度降低AI检测置信度",
                "icon": "🛡️",
                "params": {
                    "spectral_naturalize": 0.9,
                    "noise_floor_shape": 0.8,
                    "harmonic_deregularize": 0.85,
            ...
            {
                "name": "高保真模式",
                "description": "保守自然化参数，优先保证HiFi音质",
                "icon": "🎵",
                "params": {
                    "spectral_naturalize": 0.5,
                    "noise_floor_shape": 0.3,
                    "harmonic_deregularize": 0.2,
                    "phase_naturalize": 0.35,
    ...
    "v3.3a": {
        "name": "v3.3a",
        "label": "v3.3a",
        "description": "移动精简版：简化频谱自然化+瞬态保护，低计算量",
        "tags": ["mobile", "dual-track", "recommended"],
        "mobile_compatible": True,
        "supports_dual_track": True,
        "repair_version": "v3.3a",
        "default_params": {
    ...
    "v3.3a+": {
        "name": "v3.3a+",
        "label": "v3.3a+",
        "description": "移动增强版：精简自然化+残差扩散后处理",
        "tags": ["mobile", "dual-track", "premium"],
        "mobile_compatible": True,
        "supports_dual_track": True,
        "repair_version": "v3.3a+",
        ...
        "modes": [
            {
                "name": "增强自然化",
                "description": "精简自然化+残差扩散后处理，效果更优",
                "icon": "📱",
                "params": {
                    "spectral_naturalize": 0.6,
                    "noise_floor_shape": 0.4,
